 ...
 *******************************************************************************/
package com.small.test.appstub.widget.pull2refresh;
...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout implements IPullToRefresh<T>
{
            ...
            case MotionEvent.ACTION_UP:
            {
                if (mIsBeingDragged)
                {
                        ...
                        && (null != mOnRefreshListener || null != mOnRefreshListener2))
                    {
                        if (DEBUG)
                        {
                            Log.i(LOG_TAG, "MotionEvent.ACTION_UP begin");
                        }
    ...
    protected void onRefreshing(final boolean doScroll)
    {
        ...
        {
            Log.i(LOG_TAG,
                "onRefreshing doScroll=" + doScroll + ",mShowViewWhileRefreshing=" + mShowViewWhileRefreshing);
        }
        if (doScroll)
        {
            if (mShowViewWhileRefreshing)
            {
                ...
                OnSmoothScrollFinishedListener listener = new OnSmoothScrollFinishedListener()
                {
                    ...
                    public void onSmoothScrollFinished()
                    {
                        if (DEBUG)
                        {
                            Log.i(LOG_TAG, "OnSmoothScrollFinishedListener callRefreshListener()");
                        }
                        callRefreshListener();
                    }
                };
    ...
    private void callRefreshListener()
    {
        ...
        else if (null != mOnRefreshListener2)
        {
            if (mCurrentMode == Mode.PULL_FROM_START)
            {
                if (DEBUG)
                {
                    Log.i(LOG_TAG, " callRefreshListener onPullDownToRefresh");
                }
    ...
    private void init(Context context, AttributeSet attrs)
    {
        ...
        // 下拉
        String pullDownTipStart = context.getString(R.string.pull_down_start);
        String pullDownTipIng = context.getString(R.string.pull_down_ing);
        String pullDownTipEnd = context.getString(R.string.pull_down_end);
        
        // 上拉
        String pullUpTipStart = context.getString(R.string.pull_up_start);
        String pullUpTipIng = context.getString(R.string.pull_up_ing);
        String pullUpTipEnd = context.getString(R.string.pull_up_end);
        
        // We need to create now layouts now
        mHeaderLayout = createLoadingLayout(context, Mode.PULL_FROM_START, a);
        mHeaderLayout.setPullLabel(pullDownTipStart);
        mHeaderLayout.setRefreshingLabel(pullDownTipIng);
        mHeaderLayout.setReleaseLabel(pullDownTipEnd);
        
        mFooterLayout = createLoadingLayout(context, Mode.PULL_FROM_END, a);
        mFooterLayout.setPullLabel(pullUpTipStart);
        mFooterLayout.setRefreshingLabel(pullUpTipIng);
        mFooterLayout.setReleaseLabel(pullUpTipEnd);
        ...
        OnSmoothScrollFinishedListener listener)
    {
        if (DEBUG)
        {
            Log.i(LOG_TAG, "mCurrentSmoothScrollRunnable=" + mCurrentSmoothScrollRunnable);
        }
    ...
    final class SmoothScrollRunnable implements Runnable
    {
        ...
        public SmoothScrollRunnable(int fromY, int toY, long duration, OnSmoothScrollFinishedListener listener)
        {
            if (DEBUG)
            {
                Log.i(LOG_TAG, " SmoothScrollRunnable init");
            }
            mScrollFromY = fromY;
            mScrollToY = toY;
        ...
        public void run()
        {
            ...
            if (mStartTime == -1)
            {
                ...
                if (DEBUG)
                {
                    Log.i(LOG_TAG, " mStartTime=" + mStartTime);
                }
            }
            else
            {
            ...
            else
            {
                if (null != mListener)
                {
                    ...
                    {
                        Log.i(LOG_TAG,
                            "mListener.onSmoothScrollFinished(),isSmoothScrollFinished=" + isSmoothScrollFinished);
                    }
