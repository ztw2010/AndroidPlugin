package com.small.test.appstub.widget.clearedittext;
...
public class ClearEditText extends EditText{
    ...
    private void init(Context context, AttributeSet attributeSet) {
        ...
        int clearButton = typedArray.getResourceId(R.styleable.EditTextField_clearButtonDrawable, R.mipmap.delete_dark);
        typedArray.recycle();
