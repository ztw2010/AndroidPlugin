package com.small.test.appstub.widget.dialog;
...
public class AlertDialog {
    ...
    public AlertDialog builder()
    {
        ...
        // 调整dialog背景大小
        lLayout_bg
                .setLayoutParams(new FrameLayout.LayoutParams((int)(display.getWidth() * 0.85), LinearLayout.LayoutParams.WRAP_CONTENT));
