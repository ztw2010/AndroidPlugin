package com.small.test.appstub.widget.pagerslidingtabstrip;
...
public class PagerSlidingTabStrip extends HorizontalScrollView
{
    ...
    /**
     * 设置当点击TAB时,内容区域的ViewPager是否需要动画切换
     */
    ...
    protected void onDraw(Canvas canvas)
    {
        ...
        for (int i = 0; i < tabCount - 1; i++)
        {
            ...
            canvas.drawLine(tab.getRight(),
                dividerPaddingTopBottom,
                tab.getRight(),
                height - dividerPaddingTopBottom,
                dividerPaint);
        }
    }
    ...
    {
        this.tabTextSize =
            (int)TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_SP, textSizeSp, getResources().getDisplayMetrics());
        updateTabStyles();
    }
    ...
    {
        this.tabPadding =
            (int)TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, paddingDp, getResources().getDisplayMetrics());
        updateTabStyles();
    }
     ...
     * @param smoothScrollWhenClickTab
     */
