...
public class CauseFailureAdapter extends AdapterBase<CauseFailureVO>
{
    private Activity context;
    
    private LinearLayout.LayoutParams params;
    
    public CauseFailureAdapter(Activity context)
    {
    ...
    protected View getExView(int position, View convertView, ViewGroup parent)
    {
        ...
        textName.setText(lists.get(position).getReason());
