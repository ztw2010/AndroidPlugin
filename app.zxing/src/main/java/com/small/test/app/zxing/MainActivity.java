package com.small.test.app.zxing;
...
/**
 * Created by ztw on 2016/11/4.
 */

public class MainActivity extends MvpActivity<DefaultMvpPresenter> implements DefaultMvpContract.View, View.OnClickListener {
    private EditText et;
