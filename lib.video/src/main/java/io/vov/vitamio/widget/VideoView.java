...
public class VideoView extends SurfaceView implements MediaController.MediaPlayerControl {
  ...
  private OnErrorListener mErrorListener = new OnErrorListener() {
    ...
    public boolean onError(MediaPlayer mp, int framework_err, int impl_err) {
      ...
      if (getWindowToken() != null) {
        String message = framework_err == MediaPlayer.MEDIA_ERROR_NOT_VALID_FOR_PROGRESSIVE_PLAYBACK ? mContext.getString(R.string.VideoView_error_text_invalid_progressive_playback) : mContext.getString(R.string.VideoView_error_text_unknown);
        new AlertDialog(mContext).builder()
                .setCanceledOnTouchOutside(false)
                .setTitle(mContext.getString(R.string.VideoView_error_title))
                .setMsg(message)
                .setCancelable(false)
                .setPositiveButton(mContext.getString(R.string.VideoView_error_button), new OnClickListener() {
                  @Override
  ...
  private OnTimedTextListener mTimedTextListener = new OnTimedTextListener() {
    ...
    public void onTimedTextUpdate(byte[] pixels, int width, int height) {
      L.i("onSubtitleUpdate: bitmap subtitle, %dx%d", width, height);
  ...
  public void setVideoLayout(int layout, float aspectRatio) {
    ...
    L.d("VIDEO: %dx%dx%f, Surface: %dx%d, LP: %dx%d, Window: %dx%dx%f", mVideoWidth, mVideoHeight, mVideoAspectRatio, mSurfaceWidth, mSurfaceHeight, lp.width, lp.height, windowWidth, windowHeight, windowRatio);
    mVideoLayout = layout;
  ...
  public void suspend() {
    if (isInPlaybackState()) {
      ...
      L.d("Unable to suspend video. Release MediaPlayer.");
    }
  }
