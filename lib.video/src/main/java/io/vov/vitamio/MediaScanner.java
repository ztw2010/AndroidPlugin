...
public class MediaScanner {
  ...
  public void scanDirectories(String[] directories) {
    try {
      ...
      L.d(" prescan time: %dms", prescan - start);
      L.d("    scan time: %dms", scan - prescan);
      L.d("postscan time: %dms", end - scan);
      L.d("   total time: %dms", end - start);
    } catch (SQLException e) {
      L.e("SQLException in MediaScanner.scan()", e);
    } catch (UnsupportedOperationException e) {
      L.e("UnsupportedOperationException in MediaScanner.scan()", e);
    } catch (RemoteException e) {
      L.e("RemoteException in MediaScanner.scan()", e);
    }
  }
  ...
  public Uri scanSingleFile(String path, String mimeType) {
    try {
      ...
      L.e("RemoteException in MediaScanner.scanFile()", e);
      return null;
    }
  }
