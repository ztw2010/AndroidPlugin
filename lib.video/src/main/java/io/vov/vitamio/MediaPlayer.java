  ...
  public MediaPlayer(Context ctx, boolean preferHWDecoder) {
    ...
    if (preferHWDecoder) {
      ...
      try {
        ...
        L.e("unloadOMX failed %s", e.toString());
      }
  ...
  static {
    ...
    try {
      ...
      if (!vvo_loaded) {
        ...
        L.d("FALLBACK TO VVO JNI " + vvo_loaded);
      }
      loadVAO_native(LIB_ROOT + "libvao.0.so");
    } catch (UnsatisfiedLinkError e) {
      L.e("Error loading libs", e);
    }
  }
    ...
    public void handleMessage(Message msg) {
      switch (msg.what) {
        ...
        case MEDIA_SET_VIDEO_SIZE:
          ...
          return;
        case MEDIA_ERROR:
          L.e("Error (%d, %d)", msg.arg1, msg.arg2);
          ...
          return;
        case MEDIA_INFO:
          L.i("Info (%d, %d)", msg.arg1, msg.arg2);
        ...
        case MEDIA_TIMED_TEXT:
          ...
          if (mData.getInt(MEDIA_SUBTITLE_TYPE) == SUBTITLE_TEXT) {
            L.i("Subtitle : %s", mData.getString(MEDIA_SUBTITLE_STRING));
        ...
        case MEDIA_HW_ERROR:
        	...
        	return;
        default:
          L.e("Unknown message type " + msg.what);
          return;
      }
    }
  }
