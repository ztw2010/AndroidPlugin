...
public class MyMediaController extends MediaController {
    ...
    private ImageView playPauseImg;//暂停或者播放
    private ImageView deletImg;//删除本视频
    private OnDeleteListener onDeleteListener;//删除视频监听
    ...
    private OnClickListener deleteVideoListener = new OnClickListener() {
        @Override
        public void onClick(View v) {
    ...
    protected View makeControllerView() {
        View v = ((LayoutInflater) activity.getLayoutInflater()).inflate(R.layout.mymediacontroller, null);
...
//        textViewTime = (TextView)v.findViewById(getResources().getIdentifier("mediacontroller_time", "id", context.getPackageName()));
        ...
        playPauseImg = (ImageView) v.findViewById(R.id.mediacontroller_play_pause);
        deletImg = (ImageView) v.findViewById(R.id.btn_del);
        deletImg.setOnClickListener(deleteVideoListener);
...
//            mOperationBg.setImageResource(R.drawable.video_volumn_bg);
    ...
    public void setBattery(String stringBattery){
        if(textViewTime != null && img_Battery != null){
            ...
            if(battery < 15)img_Battery.setImageDrawable(ContextCompat.getDrawable(getContext(), R.mipmap.battery_15));
            if(battery < 30 && battery >= 15)img_Battery.setImageDrawable(ContextCompat.getDrawable(getContext(), R.mipmap.battery_15));
            if(battery < 45 && battery >= 30)img_Battery.setImageDrawable(ContextCompat.getDrawable(getContext(), R.mipmap.battery_30));
            if(battery < 60 && battery >= 45)img_Battery.setImageDrawable(ContextCompat.getDrawable(getContext(), R.mipmap.battery_45));
            if(battery < 75 && battery >= 60)img_Battery.setImageDrawable(ContextCompat.getDrawable(getContext(), R.mipmap.battery_60));
            if(battery < 90 && battery >= 75)img_Battery.setImageDrawable(ContextCompat.getDrawable(getContext(), R.mipmap.battery_75));
            if(battery > 90 )img_Battery.setImageDrawable(ContextCompat.getDrawable(getContext(), R.mipmap.battery_90));
        }
    }
    //隐藏/显示
    ...
    private void playOrPause(){
        if (videoView != null)
            if (videoView.isPlaying()) {
                videoView.pause();
                playPauseImg.setImageResource(R.mipmap.mediacontroller_play);
            } else {
                videoView.start();
                playPauseImg.setImageResource(R.mipmap.mediacontroller_pause);
            }
    }
