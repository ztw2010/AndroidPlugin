...
public class CameraWrapper
{
    ...
    public RecordingSize getSupportedRecordingSize(int width, int height)
    {
        ...
        {
            L.e("Failed to find supported recording size - falling back to requested: " + width + "x" + height);
            return new RecordingSize(width, height);
        }
        L.d("Recording size: " + recordingSize.getWidth() + "x" + recordingSize.getHeight());
    ...
    public void configureForPreview(int viewWidth, int viewHeight)
    {
        ...
        L.d("Preview size: " + previewSize.getWidth() + "x" + previewSize.getHeight());
    }
    ...
    protected List<Size> getSupportedVideoSizes(int currentSdkInt)
    {
        ...
        {
            L.e("Using supportedPreviewSizes iso supportedVideoSizes due to API restriction");
            supportedVideoSizes = params.getSupportedPreviewSizes();
        }
        else if (params.getSupportedVideoSizes() == null)
        {
            L.e("Using supportedPreviewSizes because supportedVideoSizes is null");
            supportedVideoSizes = params.getSupportedPreviewSizes();
        }
        else
        {
