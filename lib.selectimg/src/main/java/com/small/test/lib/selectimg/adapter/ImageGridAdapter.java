package com.small.test.lib.selectimg.adapter;
...
import com.small.test.lib.selectimg.ui.ImageBaseActivity;
                ...
                public void onClick(View v) {
                    ...
                    if (mSelectedImages.size() >= selectLimit) {
                        new AlertDialog(mActivity).builder()
                                ...
                                .setMsg(mActivity.getString(R.string.select_limit, selectLimit))
                                .setPositiveButton(mActivity.getString(R.string.sure), null)
                                .show();
                    }else{//申请相机权限
