package com.small.test.lib.selectimg;
...
/**
 * Created by ztw on 2016/11/3.
 * 图片选择器插件
 */

public class ImagePickerActivity extends MvpActivity<DefaultMvpPresenter> implements DefaultMvpContract.View, ImagePickerAdapter.OnRecyclerViewItemClickListener{
